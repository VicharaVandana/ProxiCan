...
from service19_0B_base import Ui_Form_SID_19_0B
...
class Ui_Service19_0B(Ui_Form_SID_19_0B):
    def redesign_ui(self):
        pass

    def connectFunctions(self):
        self.pushButton_Send19_0BReq.clicked.connect(self.send19_0Bservice)
    ...
    def clearform(self):
        ...
        gen.log_action("Button Click", "Clear Form for Service 19 subfunction 0B window clicked. Userfields cleared successfully.")
        return
    ...
    def addlog(self):
        ...
        gen.log_action("Button Click", "Add to Log button for Service 19 subfunction 0B window clicked.")
        return
    
    def clearlog(self):
        gen.clearudslogfile()
        self.update_status(f"Log file cleared (./reports/uds_log_report.txt)")
        gen.log_action("Button Click", "Clear Log button for Service 19 subfunction 0B window clicked.")
        return
    
    def send19_0Bservice(self):
        sprmib_flg = self.checkBox_suppressposmsg.isChecked()
        service_request = fun.form_reqmsg4srv19_subfun_B(sprmib_flg)
        ...
        if(response.type == "Positive Response"):
            self.update_status("Service 19 subfunction 0B response is received")
...
# '''
    ...
    def closeEvent(self, event):
        ...
        gen.log_action(f"Window Close", f"Service 19 0B Window Closed.")
        return
...
if __name__ == "__main__":
    ...
    Form_SID19_0B = QtWidgets.QWidget()
    ui = Ui_Service19_0B()
    ui.setupUi(Form_SID19_0B)
    ui.redesign_ui()
    ui.connectFunctions()
