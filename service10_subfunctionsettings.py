...
class Service10Subfunc_EnDis_Window(QtWidgets.QWidget):
    def __init__(self):
        super().__init__()

        # Set the window title
        self.setWindowTitle("Service 10 Subfunctions Manager")
        self.resize(400, 300)
        ...
        # Header label
        header_label = QtWidgets.QLabel("Enable or Disable Service 10 Subfunctions")
    ...
    def load_json(self):
        ...
        try:
            with open('service10_subfunctionsettings.json', 'r') as file:
                data = json.load(file)
                self.subfunc_visibility = data["Service_10_Subfunctions_Visibility"]
    ...
    def save_json(self):
        ...
        with open('service10_subfunctionsettings.json', 'w') as file:
            json.dump({"Service_10_Subfunctions_Visibility": self.subfunc_visibility}, file, indent=4)
...
if __name__ == "__main__":
    ...
    service10subfunc_enabledisable_window = Service10Subfunc_EnDis_Window()
    service10subfunc_enabledisable_window.show()
    sys.exit(app.exec_())
