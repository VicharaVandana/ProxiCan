...
"color: rgb(0, 0, 0);")
        ...
        self.gridLayout_2.addWidget(self.pushButton_Send19_0EReq, 0, 4, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.label_ResType, 4, 1, 3, 2)
...
if __name__ == "__main__":
    ...
    Form_SID_19_0E = QtWidgets.QWidget()
    ui = Ui_Form_SID_19_0E()
    ui.setupUi(Form_SID_19_0E)
    Form_SID_19_0E.show()
    sys.exit(app.exec_())