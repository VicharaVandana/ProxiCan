...
"border-color: rgb(0, 0, 255);")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.comboBox_ECUReset.setToolTip(_translate("Dialog", "Select the Diag session to which you want ECU to move. If your session is not in list then contact admin"))
        ...
        self.label_2.setText(_translate("Dialog", "Reset Type"))
        ...
        self.pushButton_Send11Req.setToolTip(_translate("Dialog", "Sends the 10 service request to ECU"))
