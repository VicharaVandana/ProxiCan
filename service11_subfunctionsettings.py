...
class Service11Subfunc_EnDis_Window(QtWidgets.QWidget):
    def __init__(self):
        super().__init__()

        # Set the window title
        self.setWindowTitle("Service 11 Subfunctions Manager")
        self.resize(400, 300)
        ...
        # Header label
        header_label = QtWidgets.QLabel("Enable or Disable Service 11 Subfunctions")
    ...
    def load_json(self):
        ...
        try:
            with open('service11_subfunctionsettings.json', 'r') as file:
                data = json.load(file)
                self.subfunc_visibility = data["Service_11_Subfunctions_Visibility"]
    ...
    def save_json(self):
        ...
        with open('service11_subfunctionsettings.json', 'w') as file:
            json.dump({"Service_11_Subfunctions_Visibility": self.subfunc_visibility}, file, indent=4)
...
if __name__ == "__main__":
    ...
    service11subfunc_enabledisable_window = Service11Subfunc_EnDis_Window()
    service11subfunc_enabledisable_window.show()
    sys.exit(app.exec_())