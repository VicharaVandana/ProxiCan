...
class Service85Subfunc_EnDis_Window(QtWidgets.QWidget):
    def __init__(self):
        super().__init__()

        # Set the window title
        self.setWindowTitle("Service 85 Subfunctions Manager")
        self.resize(400, 300)
        ...
        # Header label
        header_label = QtWidgets.QLabel("Enable or Disable Service 85 Subfunctions")
        ...
        # Add buttons for Service 85 subfunctions
        self.buttons = []
        self.button_names = ["01", "02"]  # Two subfunctions for Service 85
    ...
    def load_json(self):
        ...
        try:
            with open('service85_subfunctionsettings.json', 'r') as file:
                data = json.load(file)
                self.subfunc_visibility = data["Service_85_Subfunctions_Visibility"]
    ...
    def save_json(self):
        ...
        with open('service85_subfunctionsettings.json', 'w') as file:
            json.dump({"Service_85_Subfunctions_Visibility": self.subfunc_visibility}, file, indent=4)
...
if __name__ == "__main__":
    ...
    service85subfunc_enabledisable_window = Service85Subfunc_EnDis_Window()
    service85subfunc_enabledisable_window.show()
    sys.exit(app.exec_())
