...
"color: rgb(0, 0, 0);")
        ...
        self.gridLayout_2.addWidget(self.pushButton_Send19_0CReq, 0, 4, 1, 1)
...
if __name__ == "__main__":
    ...
    Form_SID_19_0C = QtWidgets.QWidget()
    ui = Ui_Form_SID_19_0C()
    ui.setupUi(Form_SID_19_0C)
    Form_SID_19_0C.show()
    sys.exit(app.exec_())