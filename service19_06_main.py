...
class Ui_Service19_06(Ui_Form_SID_19_06):
    ...
    def send19_06service(self):
        ...
        gen.log_action("Button Click", f"Send 19 06 request button clicked with DTC Mask Record {hex(DTCMaskRecord)} & DTC Extended Data Record Number {hex(DTCEDRN)}.")
        if status_mask == 0:
        ...
        service_request = fun.form_reqmsg4srv19_subfun_6(status_mask,sprmib_flg)
    ...
    <p><strong>Info:</strong> <I> Service 19 sunfunction 06 is successfully executed with DTC Status Mask {hex(status_mask)}</I></p>
'''
...
'''
 ...
 Explaination:   Read DTC Information (Service 19 subfunction 06) Requested for DTC Status Mask {status_mask}
