...
"border-color: rgb(0, 0, 255);")
    ...
    def retranslateUi(self, Form_SID_19_01):
        ...
        self.checkBox_statusMask_bit2.setToolTip(_translate("Form_SID_19_01", "Selecting this indicates the DTC has failed in the current or previous operation cycle and is pending ."))
        self.checkBox_statusMask_bit2.setText(_translate("Form_SID_19_01", "Pending DTC"))
        self.checkBox_statusMask_bit3.setToolTip(_translate("Form_SID_19_01", "<html><head/><body><p>Selecting this indicates that the fault has been continuously active for a specific monitoring routine and is matured enough in the current operation cycle so that it can be said confirmed. </p></body></html>"))
        ...
        self.checkBox_statusMask_bit6.setToolTip(_translate("Form_SID_19_01", "Selecting this indicates the DTC test has not completed during this current operation cycle."))
        self.checkBox_statusMask_bit6.setText(_translate("Form_SID_19_01", "Test Not Completed This Operation Cycle"))
        self.checkBox_statusMask_bit7.setToolTip(_translate("Form_SID_19_01", "Selecting this indicates that the server is requesting the warning indicator to be active."))
        ...
        self.checkBox_statusMask_bit0.setToolTip(_translate("Form_SID_19_01", "Selecting this indicates the DTC test has matured as a failure, confirming the fault as present."))
        self.checkBox_statusMask_bit0.setText(_translate("Form_SID_19_01", "Test Failed"))
        self.checkBox_statusMask_bit1.setToolTip(_translate("Form_SID_19_01", "Selecting this indicates the DTC test failed during the current operation cycle."))
        ...
        self.checkBox_statusMask_bit4.setToolTip(_translate("Form_SID_19_01", "Selecting this indicates the DTC test hasnot completed since the last DTC code clear."))
        self.checkBox_statusMask_bit4.setText(_translate("Form_SID_19_01", "Test Not Completed Since Last Clear"))
        self.checkBox_statusMask_bit5.setToolTip(_translate("Form_SID_19_01", "Selecting this indicates the DTC test has failed at least once since the last code clear."))
        ...
        self.comboBox_DTCStatusMask_entryType.setToolTip(_translate("Form_SID_19_01", "<html><head/><body><p>Select the entry method for DTC Status Mask.</p><p>\'Enable Bitwise Entry\' allows using checkboxes to set specific bits, while \'Enable Manual Entry\' allows direct hexadecimal input.</p></body></html>"))
        ...
        self.lineEdit_DTCStatusMask.setToolTip(_translate("Form_SID_19_01", "Enter the 1-byte DTC Status Mask value in hexadecimal format."))
