...
"color: rgb(0, 0, 0);")
        ...
        self.gridLayout_2.addWidget(self.DTCStatusMask_label, 1, 0, 2, 1)
        ...
        self.gridLayout_2.addWidget(self.DTCStatusMask_label_2, 3, 0, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.subFunction_Name.setText(_translate("Dialog", "Report DTC Snapshot Identification 0X03 "))
        ...
        self.pushButton_Send19_01Req.setToolTip(_translate("Dialog", "<html><head/><body><p>Sends the 19 service subfunction 01 request to ECU</p></body></html>"))
        self.pushButton_Send19_01Req.setText(_translate("Dialog", "Send Request"))
        self.label_4.setText(_translate("Dialog", "          Response : "))
        self.label_5.setText(_translate("Dialog", "Response Type: "))
        self.label_subFunction.setText(_translate("Dialog", "Sub Function:"))
        self.label_ResType.setText(_translate("Dialog", "No Response"))
        self.DTCStatusMask_label.setText(_translate("Dialog", "DTC Mask Record:"))
        ...
        self.DTCStatusMask_label_2.setText(_translate("Dialog", "DTC Snapshot Record Number:"))
